                    ...
                    if (pasteHtml) {
                        ...
                        if (pasteHtml) {
                            ...
                            resultHtml = resultHtml.replace(/<p>(https?:\/\/.*?)<\/p>/ig, function (match, link) {
                                return '<p><a href="' + link + '" target="_self">' + link + '</p>';
                            });
                        }
                    }
    ...
    E.createMenu(function (check) {
        ...
        $btnSubmit.click(function (e) {
            ...
            if (!isRangeEmpty) {
                ...
                $newLinks.attr('target', '_self'); // 增加 _self
                ...
                linkHtml = '<a href="' + url + '" target="_self">' + text + '</a>';
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $howToCopy = $('<a href="http://www.kancloud.cn/wangfupeng/wangeditor2/134973" target="_self" style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>');
        var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
...
_e(function (E, $) {
    E.plugin(function () {
        ...
        var $toolbar = $('<div class="txt-toolbar"></div>');
        var $triangle = $('<div class="tip-triangle"></div>');
        var $triggerLink = $('<a href="#" target="_self"><i class="wangeditor-menu-img-link"></i> ' + lang.openLink + '</a>');
        var isRendered;
