    ...
    <ul id="main-menu">
        ...
        <li accesskey="m">
            ...
            <ul>
                ...
                <li class="separator"></li>
                <li><a class="link" href="/united-states-declaration-of-independence?wl=1" target="_self">United States Declaration of Independence Draft</a></li>
            </ul>
        </li>
<?php
    if (!$debug) {
            ...
            <ul>
                ...
                <li id="social-reddit">
                    <div style="padding: 10px 10px 5px 10px" title="Reddit">
                        <a target="_self" href="http://www.reddit.com/submit" onclick="window.location = 'http://www.reddit.com/submit?url=' + encodeURIComponent(window.location); return false" style="color:black;text-decoration:none;"><img src="http://www.reddit.com/static/spreddit1.gif" alt="submit to reddit" border="0" />
                            <span>Reddit</span>
                        </a>
                    </div>
                </li>
