    ...
    editormd.prototype    = editormd.fn = {
        ...
        createInfoDialog : function() {
            ...
            var infoDialogHTML = [
                ...
                "<p style=\"margin: 10px 0 20px 0;\"><a href=\"" + editormd.homePage + "\" target=\"_self\">" + editormd.homePage + " <i class=\"fa fa-external-link\"></i></a></p>",
                "<p style=\"font-size: 0.85em;\">Copyright &copy; 2015 <a href=\"https://github.com/pandao\" target=\"_self\" class=\"hover-link\">Pandao</a>, The <a href=\"https://github.com/pandao/editor.md/blob/master/LICENSE\" target=\"_self\" class=\"hover-link\">MIT</a> License.</p>",
                "</div>",
            ...
            if (atLinkReg.test(text))
            {
                if (settings.atLink)
                {
                    ...
                    text = text.replace(atLinkReg, function($1, $2) {
                        return "<a href=\"" + editormd.urls.atLinkBase + "" + $2 + "\" title=\"&#64;" + $2 + "\" class=\"at-link\" target='_self'>" + $1 + "</a>";
                    }).replace(/_#_&#64;_#_/g, "@");
                }
