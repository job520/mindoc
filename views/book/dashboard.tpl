            ...
            <div class="page-right">
                <div class="m-box">
                    <div class="box-head">
                        ...
                        <a href="{{urlfor "DocumentController.Edit" ":key" .Model.Identify ":id" ""}}" class="btn btn-default btn-sm pull-right" target="_self"><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
                        {{end}}
                        <a href="{{urlfor "DocumentController.Index" ":key" .Model.Identify}}" class="btn btn-default btn-sm pull-right" style="margin-right: 5px;" target="_self"><i class="fa fa-eye"></i> 阅读</a>
