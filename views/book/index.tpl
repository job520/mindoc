                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a :href="'{{.BaseUrl}}/api/' + item.identify + '/edit'" target="_self">编辑</a></li>
                                            </template>
                                    ...
                                    {{/*<template v-if="item.role_id != 3">*/}}
                                        {{/*<a :href="'/api/' + item.identify + '/edit'" title="编辑文档" data-toggle="tooltip" target="_self"><i class="fa fa-edit" aria-hidden="true"></i> 编辑文档</a>*/}}
                                    {{/*</template>*/}}
                                </div>
