            ...
            <div class="navbar-header pull-right manual-menu">
                ...
                <div class="dropdown pull-right" style="margin-right: 10px;">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="margin-top: -5px;">
                        <li><a href="{{urlfor "DocumentController.Export" ":key" .Model.Identify "output" "pdf"}}" target="_self">PDF</a> </li>
                        <li><a href="{{urlfor "DocumentController.Export" ":key" .Model.Identify "output" "epub"}}" target="_self">EPUB</a> </li>
                        <li><a href="{{urlfor "DocumentController.Export" ":key" .Model.Identify "output" "mobi"}}" target="_self">MOBI</a> </li>
                        <li><a href="{{urlfor "DocumentController.Export" ":key" .Model.Identify "output" "docx"}}" target="_self">Word</a> </li>
                        {{if eq .Model.Editor "markdown"}}
                        <li><a href="{{urlfor "DocumentController.Export" ":key" .Model.Identify "output" "markdown"}}" target="_self">Markdown</a> </li>
                        {{end}}
                    </ul>
                </div>
                {{end}}
    ...
    <article class="container-fluid manual-body">
        <div class="manual-left">
            ...
            <div class="m-copyright">
                <p>
                    本文档使用 <a href="https://www.iminho.me" target="_self">MinDoc</a> 发布
                </p>
            </div>
        </div>
