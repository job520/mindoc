                        ...
                        <div class="list-item">
                                <div class="book-title">
                                    ...
                                    <div class="pull-right">
                                        <div class="btn-group">
                                            <a href="{{urlfor "DocumentController.Edit" ":key" $item.Identify ":id" ""}}" class="btn btn-default" target="_self">编辑</a>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="{{urlfor "DocumentController.Index" ":key" $item.Identify}}" target="_self">阅读</a></li>
                                                <li><a href="{{urlfor "ManagerController.EditBook" ":key" $item.Identify}}">设置</a></li>
                                                <li><a href="javascript:deleteBook('{{$item.BookId}}');">删除</a> </li>
                                            </ul>
                                        </div>
                                        {{/*<a href="{{urlfor "DocumentController.Index" ":key" $item.Identify}}" title="查看文档" data-toggle="tooltip" target="_self"><i class="fa fa-eye"></i> 查看文档</a>*/}}
                                        {{/*<a href="{{urlfor "DocumentController.Edit" ":key" $item.Identify ":id" ""}}" title="编辑文档" data-toggle="tooltip" target="_self"><i class="fa fa-edit" aria-hidden="true"></i> 编辑文档</a>*/}}
                                    </div>
                                ...
                                <div class="desc-text">
                                    ...
                                    &nbsp;
                                    {{else}}
                                        <a href="{{urlfor "ManagerController.EditBook" ":key" $item.Identify}}" title="编辑项目" style="font-size: 12px;" target="_self">
                                            {{$item.Description}}
                                        </a>
                                    {{end}}
                                </div>
