                    ...
                    <div class="ui items">
                        {{range $index,$item := .ModelList}}
                            <div class="item blog-item">
                                <div class="content">
                                    <a class="header" href="{{urlfor "BlogController.Index" ":id" $item.BlogId}}" target="_self">
                                    ...
                                    <div class="extra">
                                        <div>
                                            <div class="ui horizontal small list">
                                                ...
                                                <div class="item"><a href="{{urlfor "BlogController.ManageEdit" ":id" $item.BlogId}}" title="文章编辑" target="_self"><i class="fa fa-edit"></i> 编辑</a></div>
